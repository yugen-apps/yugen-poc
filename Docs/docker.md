...
> docker compose --file docker-compose.yml --file docker-compose.windows.yml up --detach

### Linux

> docker compose --file docker-compose.yml --file docker-compose.linux.yml up --detach

### Asustor

> sudo docker compose --file docker-compose.yml --file docker-compose.asustor.yml up --detach

### Unraid

> sudo docker compose --file docker-compose.yml --file docker-compose.unraid.yml up --detach

## Poc.Ef.Aspnet

### Windows

> docker compose --file docker-compose.yml --file docker-compose.windows.yml up --detach poc-docker-aspnet

> docker compose --file docker-compose.yml --file docker-compose.windows.yml build poc-docker-aspnet

> docker compose --file docker-compose.yml --file docker-compose.windows2.yml run --publish 9998:8443 --detach poc-docker-aspnet

### Linux

> docker compose --file docker-compose.yml --file docker-compose.linux.yml up --detach poc-docker-aspnet

> docker compose --file docker-compose.yml --file docker-compose.linux.yml build poc-docker-aspnet

> docker compose --file docker-compose.yml --file docker-compose.linux2.yml run --publish 9998:8443 --detach poc-docker-aspnet --no-deps

### Asustor

> sudo docker compose --file docker-compose.yml --file docker-compose.asustor.yml run --publish 3000:8443 --detach poc-docker-aspnet --no-deps

### Unraid

> sudo docker compose --file docker-compose.yml --file docker-compose.unraid.yml run --publish 3000:8443 --detach poc-docker-aspnet --no-deps
