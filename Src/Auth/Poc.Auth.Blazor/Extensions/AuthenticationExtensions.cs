...
public static class AuthenticationExtensions
{
    ...
    public static void AddDownstreamApi(
        ...
        IConfigurationSection graphConfigurationSection)
    {
        var microsoftGraphOptions = graphConfigurationSection.Get<MicrosoftGraphOptions>() ?? throw new Exception();
        ...
        services.AddAuthentication(OpenIdConnectDefaults.AuthenticationScheme)
            ...
            .EnableTokenAcquisitionToCallDownstreamApi(microsoftGraphOptions.Scopes)
