...
public class RedisService : IRedisService
{
    ...
    public async Task<long> PublishAsync(AppMessage message)
    {
        ...
        var subscribersCount = await _subscriber.PublishAsync(RedisChannel.Literal(ChannelName), json);
    ...
    public async Task<RedisValue[]> ConsumeAndStackDeleteAsync()
    {
        ...
        var messages = await _db.StreamReadAsync(StreamKey, "0-0", count: 1);
